		...
		if ( current_user_can( 'manage_options' ) ) {
			?>
				<div class="error polygon-warning">
					<p></p>
					<p>
						<b><?php echo __( 'WARNING: You server is running outdated software!', 'autoremove-attachments' ); ?></b>
					</p>
					<p>
						<?php printf( __( 'Autoremove Attachments can not run on PHP versions older than %1$s. You are running on version %2$s. Upgrade your PHP version or switch to a decent host.', 'autoremove-attachments' ), $this->minimum_version, PHP_VERSION ); ?>
					</p>
					<p></p>
				</div>
			<?php
